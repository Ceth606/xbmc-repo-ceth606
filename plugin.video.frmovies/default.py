...
def CATEGORIES():
	...
	addDir('RECHERCHER',' ',5, 'http://frmovies.net/imdoc/frmovies1.png')
...
if mode==None or url==None or len(url)<1:
	...
	addDir('NEXT',url+pp,1,'http://frmovies.net/imdoc/frmovies1.png')
	addDir('CHERCHER',' ',5,'http://frmovies.net/imdoc/frmovies1.png')
